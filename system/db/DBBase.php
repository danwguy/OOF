<?php
    ...
    class DBBase extends Singleton {
        ...
        protected function _setup_driver() {
            ...
            if(!$matches) {
                OOF::show_error(
                   "You do not have a valid database type in your config file. Please open the site config
            ...
            if(file_exists(SYS_PATH . $this->_drivers_paths . $type_name . '/' . $driver . '.php')) {
                ...
                OOF::show_error(
                   "We are unable to find the driver file you specified in the database config." . "\r\n" .
                   "In file: " . SYS_PATH . $this->_drivers_paths . $type_name . '/' . $driver . '.php');
                exit;
            }
            if(!class_exists($driver)) {
                OOF::show_error(
                   "We were unable to find the driver class specified. Please ensure that there is a
