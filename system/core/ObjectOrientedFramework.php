...
if (file_exists(APP_PATH . '/config/' . ENVIRONMENT . '/dw.oof')) {
    require_once(APP_PATH . '/config/' . ENVIRONMENT . '/dw.oof');
} else if (file_exists(APP_PATH . '/config/dw.oof')) {
    require_once(APP_PATH . '/config/dw.oof');
}
