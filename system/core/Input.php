<?php
    ...
    class Input extends Singleton {
        ...
        public function set_cookie() {
            ...
            $possibles = array('name'   => '', 'value' => '', 'expire' => '', 'domain' => '', 'path' => '/',
                               'prefix' => '', 'secure' => false);
...
//            }
        ...
        public function ip_address() {
            ...
            if(!empty($proxies)) {
                ...
                foreach(array('HTTP_X_FORWARDED_FOR', 'HTTP_CLIENT_IP', 'HTTP_X_CLUSTER_CLIENT_IP',
                              'HTTP_X_CLIENT_IP') as $header) {
        ...
        private function _sanitize_globals() {
            $protected = array('_SERVER', '_GET', '_POST', '_FILES', '_REQUEST', '_SESSION', '_ENV', 'GLOBALS',
                               'HTTP_RAW_POST_DATA', 'system_folder', 'application_folder', 'BM', 'EXT', 'CFG', 'URI',
                               'RTR',
                               'OUT', 'IN');
