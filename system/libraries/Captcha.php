<?php
    ...
    class Captcha extends Singleton {
        ...
        public function create($data = null, $img_path = null, $img_url = null, $font_path = null) {
            ...
            if(substr($this->img_url, strlen($this->img_url) - 1, strlen($this->img_url)) != '/'
               || substr($this->img_url, strlen($this->img_url) - 1, strlen($this->img_url)) != DS
            ) {
                $this->img_url .= '/';
            }
            ...
            $this->image = '<img src="' . $this->img_url . $img_name . '" width="' . $this->img_width . 'px" height="'
                           . $this->img_height . 'px" style="border: 0;" />';
